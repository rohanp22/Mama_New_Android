...
public class FcmListenerService extends FirebaseMessagingService {
    ...
    private final String PREFERENCE_FILE = "com.wielabs.mama.shared_preferences";
    ...
    private void createNotification(String userId) {
        ...
        //PendingIntent contentIntent = PendingIntent.getActivity(getApplicationContext(), 0, new Intent(getApplicationContext(), LoginActivity.class), 0);
